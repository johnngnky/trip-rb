...
export class Dropdown extends Tripetto.NodeProvider<{}, JSX.Element, IDropdown> {
    ...
    public OnRender(context: {}, instance: Tripetto.Instance, action: Tripetto.Await): JSX.Element {
        const data = this.Data<string>(instance, "option");
        const value = data ? data.Reference : "";
        ...
        return (
            <label title={this.Node.Props.Explanation}>
                ...
                <select defaultValue={value} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => this.Update(data, e.target.value)}>
    ...
    public OnValidate(instance: Tripetto.Instance): boolean {
        ...
        return data ? !data.Slot.Required || data.Reference !== "" : false;
    }
}
